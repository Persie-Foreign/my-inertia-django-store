...
import ShippingPolicyModal from "./components/ShippingPolicyModal.jsx";
import RefundPolicyModal from "./components/RefundPolicyModal.jsx";
...
const CheckoutSection = () => {
    ...
    console.log('isInputFilled:', isInputFilled, 'discountCode:', discountCode);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {/* Left Checkout Form */}
                <div className="w-full lg:w-1/2 flex-1 overflow-y-auto ">
                    ...
                    <div className="mb-6 mt-6">
                        ...
                        <div className="mt-2 flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                            {/* Shop Pay - Full width on mobile, 1/3 on desktop */}
                            <button className="bg-purple-600 w-full sm:w-1/3 rounded-lg flex items-center justify-center h-[3rem] object-cover">
                                <img src="/static/images/shop_pay-removebg-preview.png" alt="shop pay" />
                            </button>

                            {/* PayPal + Google Pay - Side by side on mobile inside this row */}
                            <div className="flex space-x-4 w-full sm:w-2/3">
                                {/* PayPal */}
                                <button className="bg-yellow-400 w-1/2 rounded-lg flex items-center justify-center h-[3rem] object-cover">
                                    <img
                                ...
                                {/* Google Pay */}
                                <button className="bg-black w-1/2 rounded-lg flex items-center justify-center h-[3rem] object-cover">
                                    <img
                                        src="/static/images/google_pay-removebg-preview.png"
                                        alt="Google Pay"
                    ...
                    <div className="mb-10">
                        <div className="mb-10">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <a href="/accounts/Login" className="text-black text-sm underline">
                                    Log in
                                </a>
                            </div>
                                ...
                                <div className="col-span-2">
                                    <div className="relative overflow-visible">
                                        ...
                                        <div className="absolute inset-y-0 right-3 flex items-center group">
                                            ...
                                            {/* Tooltip bubble */}
                                            <div className="absolute hidden group-hover:block w-[8rem] p-2 bg-gray-800 text-white text-xs text-center rounded-lg shadow-lg bottom-full right-[-0.5rem] z-10">
                                                In case we need to contact you about your order
                                                <div className="absolute bottom-0 right-[10%] w-2 h-2 bg-gray-800 rotate-45 transform translate-y-1/2"></div>
                                            </div>
                                    ...
                                    <div className="bg-gray-50 px-4 py-4 space-y-4">
                                        ...
                                        {!useShippingAsBilling && (
                                            ...
                                            <div className="grid grid-cols-1 gap-4">
                                                ...
                                                {/* City + State + Zip (3 columns on sm+) */}
                                                ...
                                                {/* Phone + tooltip (always full width) */}
                                                <div className="relative">
                                                    <input
                                                        type="tel"
                                                        placeholder="Phone"
                    ...
                    <div className="mt-6 cursor-pointer hidden lg:block">
                        <button
                    ...
                    <div className="mt-[5rem] space-x-2 border-t border-gray-300 pt-4  hidden lg:block">
                ...
                <span className="inline-flex items-center space-x-1">
                    ...
                    {/* Payment Button */}
                    <div className="mt-4 cursor-pointer block lg:hidden">
                        <button
                            className={`w-full text-2xl py-3 rounded-lg font-bold transition-colors cursor-pointer ${
                                selectedMethod === 'paypal'
                                    ? 'bg-blue-600 text-white'
                    ...
                    <div className="mt-4 cursor-pointer block lg:hidden space-x-4">
                        <a href="#" className="underline text-sm cursor-pointer" onClick={() => setIsRefundModalOpen(true)}>Refund Policy</a>
                        <a href="#" className="underline text-sm cursor-pointer" onClick={() => setIsShippingModalOpen(true)}>Shipping Policy</a>
                        <a href="#" className="underline text-sm cursor-pointer" onClick={() => setIsPrivacyModalOpen(true)}>Privacy Policy</a>
                        <a href="#" className="underline text-sm cursor-pointer" onClick={() => setIsTermsModalOpen(true)}>Terms of Service</a>
