        ...
        <div className="bg-white w-full h-15">
            ...
            {isFilterOpen && (
                <>
                    ...
                    {/* Sidebar */}
                    <div className="fixed right-0 top-0 h-full w-80 bg-white shadow-lg z-30 p-6 overflow-y-auto">
            ...
            {isSortOpen && (
                <>
                    {/* Backdrop */}
                    <div
                        className="fixed inset-0 bg-black/75 bg-opacity-50 z-30"
                        onClick={() => setIsSortOpen(false)}
                    />

                    {/* Bottom Sheet */}
                    <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-lg z-30 p-4 sm:hidden">
                        <div className="flex justify-between items-center mb-4">
